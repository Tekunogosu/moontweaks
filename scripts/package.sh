...
# MoonSharp is compiled into the assembly rather than shipped beside it, so the
# zip is a binary redistribution of it. Its licence requires the notice to travel
# with the distribution, which is what THIRD-PARTY-NOTICES.md is doing here.
