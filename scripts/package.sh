...
# MoonSharp is compiled into the assembly rather than shipped beside it, and
# Lua-CSharp travels beside it as Lua.dll, so the zip is a binary redistribution of
# both. Their licences require the notice to travel with the distribution, which is
# what THIRD-PARTY-NOTICES.md is doing here.
